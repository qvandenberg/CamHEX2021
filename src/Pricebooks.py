...
'''
Keep a reference of the latest price book submitted by the venue.

The orders posted here can contain outliers so we do not use them to estimate any price; rather
we score these prices with respect to the recent trade history.
